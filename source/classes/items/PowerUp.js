export default class PowerUp {
    ...
    draw(ctx) {
        ...
        ctx.fillRect(-this.width / 2 * pulse, -this.height / 2 * pulse, this.width * pulse, this.height * pulse);
        
        // Draw inner bright square
        ctx.fillStyle = '#ffffff';
        ctx.fillRect(-this.width / 4 * pulse, -this.height / 4 * pulse, this.width / 2 * pulse, this.height / 2 * pulse);
